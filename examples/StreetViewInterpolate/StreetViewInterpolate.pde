...
PVector start = new PVector(45.537734, -73.622578);
PVector finish =  new PVector(45.52015,-73.583357);
...
void draw() {
	...
	// strokeWeight(4);
	// 
	// line(((3.5-yaw/360*7+7)%7)*width/7-width/2, -height/2, ((3.5-yaw/360*7+7)%7)*width/7-width/2, height/2);
}
